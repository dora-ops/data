...
-- ----------------------------
INSERT INTO `t_customer` VALUES ('1', 'KH21321321', '北京大牛科技', '北京', '小张', '战略合作伙伴', '☆☆☆', '☆☆☆', '北京海淀区双榆树东里15号', '100027', '010-62263393', '010-62263393', 'www.daniu.com', '420103000057404', '张三', '1000', '5000', '中国银行 ', '6225231243641', '4422214321321', '4104322332', '1');
INSERT INTO `t_customer` VALUES ('16', 'KH20150526073022', '风驰科技', '北京', '小红', '大客户', '☆', '☆', '321', '21', '321', '321', '321', '321', '321', '', '21', '321', '321', '321', '3213', '1');
...
INSERT INTO `t_customer` VALUES ('28', 'KH20150729090910', '12', '南京', '小张', '战略合作伙伴', '☆☆☆☆☆', '☆☆☆☆☆', '62', '22', '32', '42', '52', '112', '722', '122', '82', '102', '92', '132', '142', '1');
...
INSERT INTO `t_customer_contact` VALUES ('2', '1', '2015-05-06', '12', '22');
INSERT INTO `t_customer_contact` VALUES ('3', '1', '2015-08-22', '珠江路2', '吃饭2');
...
INSERT INTO `t_customer_linkman` VALUES ('10', '1', 'da', '女', 's', 'fd', 'fda');
...
INSERT INTO `t_customer_loss` VALUES ('10', 'KH20150526073023', '巨人科技', '小丽', '2014-02-03', null, '0', null);
INSERT INTO `t_customer_loss` VALUES ('11', 'KH20150729090910', '12', '小张', null, null, '0', null);
INSERT INTO `t_customer_loss` VALUES ('12', 'KH21321321', '北京大牛科技', '小张', '2015-07-01', null, '0', null);
...
-- ----------------------------
INSERT INTO `t_customer_order` VALUES ('1', '1', 'DD11213', '2015-07-01', '11', '0');
INSERT INTO `t_customer_order` VALUES ('2', '16', 'DD11212', '2014-03-02', '22', '1');
...
-- ----------------------------
INSERT INTO `t_customer_reprieve` VALUES ('1', '9', 'ss2');
INSERT INTO `t_customer_reprieve` VALUES ('3', '10', '111');
INSERT INTO `t_customer_reprieve` VALUES ('4', '9', '打电话咨询客户');
INSERT INTO `t_customer_reprieve` VALUES ('5', '9', '请吃饭');
...
INSERT INTO `t_customer_service` VALUES ('10', '建议', '32', '32', '已分配', '32', 'Jack', '2015-06-04 00:00:00', '小明', '2016-03-13 00:00:00', null, null, null, null, null);
...
INSERT INTO `t_customer_service` VALUES ('15', '咨询', '问下think pad xx型号 多少钱？', '大牛科技', null, 'xxxx.\r\nxxx.\r\nxxxxx\r\n嗯。', 'Jack', '2015-08-25 00:00:00', null, null, null, null, null, null, null);
INSERT INTO `t_customer_service` VALUES ('16', '投诉', '垃圾电脑，刚用就坏。', '牛逼科技', '已归档', '嘻嘻嘻\r\n范德萨', 'Jack', '2015-08-25 00:00:00', '小明', '2015-08-27 00:00:00', '进行了....客户交流。。。\r\n', 'Jack', '2015-08-31 00:00:00', 'OK', '☆☆☆☆☆');
...
INSERT INTO `t_cus_dev_plan` VALUES ('24', '1', '213', '2015-07-14', '321');
...
-- ----------------------------
INSERT INTO `t_sale_chance` VALUES ('1', '主动来找的', '风软科技', '100', '采购笔记本意向', '张先生', '137234576543', '。。。', 'Jack', '2014-01-01 00:00:00', '3', '2015-05-24 16:15:00', '1', '3');
INSERT INTO `t_sale_chance` VALUES ('2', '', '1', '12', '', '', '', '', '12', null, '3', '2015-05-25 11:21:00', '1', '2');
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('1', 'admin', '123', 'Jack', 'java1234@qq.com', '123456789', '系统管理员');
